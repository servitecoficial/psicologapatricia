   ...
   // let imei = document.querySelector("#imei").value;
    ...
    let url = `https://api.whatsapp.com/send?phone=541161372870&text=
          ...
          *INFORMACIÓN DEL PACIENTE.
          Se recuerda que la cancelacion tiene que ser con 24 horas de antelación. Desde ya muchas gracias*%0A%0A
          ...
          *Indica la fecha de tu reserva a cancelar*%0A
          ${fecha}%0A
          *Indica la hora de tu reserva a cancelar*%0A
          ${hora}%0A
